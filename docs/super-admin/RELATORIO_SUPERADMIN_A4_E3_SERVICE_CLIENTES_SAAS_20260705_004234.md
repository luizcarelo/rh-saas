...
```text
/opt/rh-saas/docs/super-admin/superadmin_A4_E3_service_clientes_saas_20260705_004234/patch_service_clientes.log
```

Service grep:

```text
/opt/rh-saas/docs/super-admin/superadmin_A4_E3_service_clientes_saas_20260705_004234/service_grep.txt
```

TypeScript log:

```text
/opt/rh-saas/docs/super-admin/superadmin_A4_E3_service_clientes_saas_20260705_004234/frontend_tsc.log
```

Build log:

```text
/opt/rh-saas/docs/super-admin/superadmin_A4_E3_service_clientes_saas_20260705_004234/frontend_build.log
```

Diretório:

```text
/opt/rh-saas/docs/super-admin/superadmin_A4_E3_service_clientes_saas_20260705_004234
```

## Backup

```text
/opt/rh-saas/backups/sprint_superadmin_A4_E3_service_clientes_saas_20260705_004234
```
