...
```text
/opt/rh-saas/docs/super-admin/superadmin_A1_diag_20260704_232158/login_response_redacted.json
```

Análise do login:

```text
/opt/rh-saas/docs/super-admin/superadmin_A1_diag_20260704_232158/login_analysis.txt
```
...
```text
/opt/rh-saas/docs/super-admin/superadmin_A1_diag_20260704_232158/frontend_superadmin_raw.txt
```

Backend raw:

```text
/opt/rh-saas/docs/super-admin/superadmin_A1_diag_20260704_232158/backend_superadmin_raw.txt
```

DB raw:

```text
/opt/rh-saas/docs/super-admin/superadmin_A1_diag_20260704_232158/db_superadmin_raw.txt
```

Diretório:

```text
/opt/rh-saas/docs/super-admin/superadmin_A1_diag_20260704_232158
```

## Backup documental

```text
/opt/rh-saas/backups/sprint_superadmin_A1_diagnostico_acesso_20260704_232158
```
