...
export class CreateEmployeeNotifications004 implements MigrationInterface {
  public async up(
    ...
    await queryRunner.createIndex(
      'employee_notifications',
      new TableIndex({
        name: 'IDX_NOTIFICATION_DELETED_AT',
